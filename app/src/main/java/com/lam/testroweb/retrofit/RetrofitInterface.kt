...
interface RetrofitInterface {
    ...
    @GET("movie/{movie_id}") fun getgMovieDetails(@Path("movie_id") movieId:String, @Query("api_key") apiKey:String): Observable<UpcomingModel>
    @GET("movie/{movie_id}/credits") fun getCredits(@Path("movie_id") movieId:String, @Query("api_key") apiKey:String): Observable<UpcomingModel>
